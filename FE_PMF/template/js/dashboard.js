(function($) {
    ...
    $(function() {
        ...
        var salesanalyticData = {
            labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oc", "No", "De"],
            datasets: [{
                    label: 'Critical',
                    data: [24, 23, 22, 24, 26, 23, 23, 50, 10, 22, 33, 11],
                    borderColor: [
                        '#3022cb'
                    ],
                    borderWidth: 3,
                ...
                {
                    label: 'Warning',
                    data: [26, 27, 26, 22, 25, 26, 24, 50, 15, 16, 33, 18],
                    borderColor: [
                        '#ff8300',
                    ],
                    borderWidth: 3,
                ...
                {
                    label: 'Error',
                    data: [25, 28, 24, 28, 29, 27, 25, 50, 10, 18, 12, 40],
                    borderColor: [
                        '#f2125e',
                    ],
                    borderWidth: 3,
